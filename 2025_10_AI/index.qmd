...
title-slide-attributes:
  data-background-image: "assets/rubin.jpg"
...
<br/>
<span style="color:#1a237e;">Learn core JAX transforms (jit, vmap, grad) and Flax tooling</span>
<br/>
<br/>
...
![Deblender architecture](assets/ai/deblender_diagram.png){width=85% .img-border-2}

::: {.fragment fragment-index=2 .fade-in}

![Distribution e1/e2](assets/ai/distribution_e1_e2_recon_pred_no_filtered.png){width=95% .img-border-2}
...
![Reconstructions](assets/ai/recons_t2.png){width=95% .img-border-2}
...
# grad w.r.t. first arg
dl_dw = jax.grad(loss)(w, x, y)
# 2nd derivative
dl_dl_dw = jax.grad(jax.grad(loss))(w, x, y)
# Hessian matrix
hessian_dw = jax.hessian(loss)(w, x, y)
```
...
### One training step in JAX + Flax + Optax
...
![Variational Autoencoder](assets/ai/autoencoder-architecture.png){width=70% .img-border-2 fig-align="center"}
...
![VAE latent space to redshift](assets/ai/deblender_diagram.png){width=70% .img-border-2 fig-align="center"}
