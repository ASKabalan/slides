...
![Power spectrum 1024](assets/gpu_memory_sizes.png){.nostretch fig-align="center" width="400px"}
...
![Power spectrum](assets/gpu_memory_sizes.png){.nostretch fig-align="center" width="400px"}
...
![Second slice](assets/LPT_density_field_z0_0_no_halo.png){.nostretch fig-align="center" width="400px"}

![Third slice](assets/LPT_density_field_z0_0_no_halo.png){.nostretch fig-align="center" width="400px"}

![Fourth slice](assets/LPT_density_field_z0_0_no_halo.png){.nostretch fig-align="center" width="400px"}
...
#### jaxDecomp Halo exchange

```python
import jaxdecomp

halo_size = 128
field = jaxdecomp.halo_exchange(field, halo_extent=halo_size)
...
![Final field](assets/field-init.png){.nostretch fig-align="center" width="800px"}
