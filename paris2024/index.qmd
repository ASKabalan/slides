...
<div style="display: flex; justify-content: space-around; align-items: center; layout-valign="middle">
  <img src="assets/Logos/AstroDeep-2.png" style="width: 25%;"/>
  <img src="assets/Logos/APC.png" style="width: 15%;"/>
  <img src="assets/Logos/scipol-removebg-preview.png" style="width: 25%;"/>
</div>
'
---
...
- <span style="color:#521463; font-size: 28px;">**Motivation**</span>: Understand the value of full-field inference in cosmology.
<br />
<br />
- <span style="color:#521463; font-size: 28px;">**Background on Parallelism**</span>: Learn how GPUs work and key scaling concepts.
<br />
<br />
- <span style="color:#521463; font-size: 28px;">**When to Use (and Avoid) Parallelism**</span>: Discover the benefits and limitations.
<br />
<br />
- <span style="color:#521463; font-size: 28px;">**Scaling with JAX**</span>: Explore techniques for scaling computations in JAX.
<br />
<br />
- <span style="color:#521463; font-size: 28px;">**Distributed Tools for Cosmology**</span>: Get an overview of multi-node packages like `jaxDecomp` and `jaxPM`.
<br />
<br />
- <span style="color:#521463; font-size: 28px;">**Hands-On Practice**</span>: Apply these concepts in interactive notebooks.
