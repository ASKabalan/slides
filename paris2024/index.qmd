...
variance = 1.0
x = jnp.linspace(-5, 5, 128)
x = jax.device_put(sharding, x) ❌ # DOES NOT WORK
result = gaussian(x, mean, variance)
visualize_array_sharding(x)
visualize_array_sharding(result)
...
- Manages boundary conditions for particles leaving the simulation domain.
...
![](assets/jaxDecomp/strong_scaling.png){fig-align="center" width="35%"}

#### Weak scaling


![](assets/jaxDecomp/weak_scaling.png){fig-align="center" width="35%"}
